...
export class Iterator {
  ...
  private _filters: ((repo: Data.Repository) => boolean)[] = [];
  ...
  withFilter(callback: (repo: Data.Repository) => boolean): this {
  ...
  fetch(callback: Utils.IteratorCallback) {
    _.forEach(ORGANIZATIONS, (load: () => any[]) => {
      ...
      forEachSeries<Data.Repository>(repos.value(), async (repo) => {
